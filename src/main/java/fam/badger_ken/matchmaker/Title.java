...
public class Title implements Comparable<Title> {
    ...
    public final TitleRank rank;  // the higher the rank, the more important this title is.
    public final HowHeld howHeld;  // how did you get this title?
    public final boolean isMale;  // is this title for a male?
    // maps from a holding level to its title rank
    private static Map<HoldingLevel, TitleRank> holdingTitleMap = null;

    public static final Title TITLE_NONE = new Title(TitleRank.NONE, HowHeld.BY_HOLDING, true);
    ...
    public static Title MakeInheritedTitle(Title dadTitle, Title momTitle, boolean isMale) {
        ...
        boolean fromDad = bestTitle == dadTitle;
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            return howHeld == other.howHeld && rank == other.rank;
        }
    }
}
