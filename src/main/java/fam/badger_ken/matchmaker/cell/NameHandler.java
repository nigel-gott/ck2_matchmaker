...
public class NameHandler implements CellHandler {
  ...
  public int compare(Person arg0, Person arg1) {
    String name0 = arg0.getDisplayName(matchmaker.gameConfig);
    String name1 = arg1.getDisplayName(matchmaker.gameConfig);
  ...
  public Component getTableCellRendererComponent(JTable table, Object value,
    ...
    String val = person.getDisplayName(matchmaker.gameConfig);
