...
/**
 * The 'KidsFilter' filters for min/max # of kids
 */
public class KidsFilter extends IntegerFilter {

  public KidsFilter(ResultMaker resultMaker, boolean isMinFilter) {
    super(resultMaker, isMinFilter);
  }

  @Override
  public Integer evaluatePerson(Person person) {
    return person.getNumKids();
  }
}
