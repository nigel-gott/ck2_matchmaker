...
public class PrestigeFilter extends IntegerFilter {

  public PrestigeFilter(ResultMaker resultMaker, boolean isMinFilter) {
    super(resultMaker, isMinFilter);
  }

  @Override
  public Integer evaluatePerson(Person person) {
    return person.prestige == null ? 0 : (int) person.prestige.shortValue();
  }
}
